...
import { PureComponent } from '@react-google-maps/api/dist/components/maps/node_modules/react';
...
export declare class TrafficLayer extends PureComponent<TrafficLayerProps, TrafficLayerState> {
    static contextType: import("@react-google-maps/api/dist/components/maps/node_modules/react").Context<google.maps.Map<Element> | null>;
    state: {
        trafficLayer: null;
    };
