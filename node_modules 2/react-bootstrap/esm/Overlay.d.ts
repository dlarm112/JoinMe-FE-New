import React from 'react-bootstrap/esm/node_modules/react';
import PropTypes from 'react-bootstrap/esm/node_modules/prop-types';
import { OverlayProps as BaseOverlayProps } from 'react-bootstrap/esm/node_modules/react-overlays/Overlay';
import { TransitionType } from 'react-bootstrap/esm/helpers';
export declare type Placement = import('react-bootstrap/esm/node_modules/react-overlays/usePopper').Placement;
...
declare namespace Overlay {
    ...
    var defaultProps: {
        transition: React.ForwardRefExoticComponent<Pick<import("react-bootstrap/esm/Fade").FadeProps, React.ReactText> & React.RefAttributes<import("react-bootstrap/esm/node_modules/react-transition-group/Transition").default<any>>>;
        rootClose: boolean;
        show: boolean;
        placement: string;
    };
